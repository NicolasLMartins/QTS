...
public class GerenciadorContasTest_Ex05 {
    ...
    public void testTransfereValor() {
        ...
        ContaCorrente cc1 = new ContaCorrente(idConta01, 1000.0, true);
        ContaCorrente cc2 = new ContaCorrente(idConta02, 200.0, true);
